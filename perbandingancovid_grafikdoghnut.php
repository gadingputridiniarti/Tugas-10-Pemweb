...
include ('koneksi.php'); 
	...
	while ($row = mysqli_fetch_array($kasus) ) {
		...
		$query = mysqli_query($conn,"select totalcase, totaldeath, totalrecover, activecase, totaltest from tb_covid where id_covid='". $row['id_covid']."'"); 
...
<html> 
<head>
	<title>Perbandingan Doughnut Chart</title>
<script type="text/javascript" src="Chart.js"></script></head> 
<body>
	<br>
	<h1 style="font-display: Calibri;" "font-family: Calibri;" font align=center>Doughnut Chart - Table Covid</h1>
	<br>
